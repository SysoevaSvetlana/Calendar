# 🎥 Booking System for Videographer 

**Веб-приложение для онлайн-бронирования съёмок с интеграцией Yandex Calendar и подтверждением заявок по email.**  
...
- 📅 Посмотреть свободные даты и время (синхронизировано с Yandex Calendar)
...
## 📆 Интеграция с Yandex Calendar

- Чтение существующих событий из Yandex Calendar
...
5. После подтверждения:
    ...
    - событие появляется в Yandex Calendar
